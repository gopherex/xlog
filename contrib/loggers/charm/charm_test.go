...
import (
	...
	cladapter "github.com/gopherex/xlog/contrib/loggers/charm"
)
...
func TestCharmAdapterLevelMapping(t *testing.T) {
	cases := []struct {
		log  func(*xlog.Logger)
		want string
	}{
		{func(l *xlog.Logger) { l.Log(xlog.TraceLevel, "m") }, "debug"},
		{func(l *xlog.Logger) { l.Log(xlog.CriticalLevel, "m") }, "fatal"},
	}
	for _, tc := range cases {
		...
		tc.log(xlog.New(cladapter.New(l)))
